...
export default function Home() {
  return (
    ...
    <section>
      <div
        className="container2-xl bg-darkdeep1 pt-50px md:pt-20 pb-205px md:pb-35 rounded-2xl relative overflow-hidden shadow-brand"
      >
        <div className="container grid grid-cols-1 lg:grid-cols-2 items-center">
          <div data-aos="fade-up">
            <h3
              className="uppercase text-secondaryColor text-size-15 mb-5px md:mb-15px font-inter tracking-5px"
            >
              EDUCATION SOLUTION
            </h3>
            <h1
              className="text-3xl text-whiteColor md:text-6xl lg:text-size-50 2xl:text-6xl leading-10 md:leading-18 lg:leading-62px 2xl:leading-18 md:tracking-half lg:tracking-normal 2xl:tracking-half font-bold mb-15px"
            >
     ...
     <div data-aos="fade-up">
      <div
        className="container2-md flex flex-wrap items-center justify-center bg-white dark:bg-whiteColor-dark rounded-md mx-auto md:-translate-y-1/2 w-full shadow-brand"
      >
        <div
          className="basis-1/2 md:basis-1/4 lg:basis-1/5 flex justify-center py-5 lg:py-35px 2xl:py-45px"
        >
          <a href="#"
      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 pt-30px gap-x-30px">
          ...
          >
            ...
            <div
              className="px-10px py-3 md:py-25px border-l-4 border-primaryColor shadow-experience absolute bottom-0 left-0 bg-white dark:bg-whiteColor-dark animate-move-var w-[290px]"
            >
              <div className="counter flex items-center">
                <p
                  className="text-[40px] text-primaryColor font-bold uppercase pr-10px leading-1"
                >
                  <span data-countup-number="25">25</span>+
                </p>
                <p
                  className="text-blackColor dark:text-blackColor-dark font-bold leading-26px"
                >
          ...
          <div data-aos="fade-up">
            ...
            >
              Welcome to the
              <span
                className="relative after:w-full after:h-[7px] after:bg-secondaryColor after:absolute after:left-0 after:bottom-3 md:after:bottom-5"
                >Online</span
              >
              Learning Center
            </h3>
            <p
              className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark mb-6 pl-3 border-l-2 border-primaryColor"
            >
            ...
            <ul className="space-y-5">
              <li className="flex items-center group">
                <i
                  className="icofont-check px-2 py-2 text-primaryColor bg-whitegrey3 bg-opacity-40 group-hover:bg-primaryColor group-hover:text-white group-hover:opacity-100 mr-15px dark:bg-whitegrey1-dark"
                ></i>
                <p
                  className="text-sm md:text-base font-medium text-blackColor dark:text-blackColor-dark"
                >
        ...
        <div
          className="counter flex flex-wrap py-[70px] lg:py-20 gap-y-30px lg:gap-y-0"
        >
          <div
          ...
          >
            <div className="flex gap-4">
              ...
              <div>
                <p
                  className="text-size-34 leading-[1.1] text-blackColor font-bold font-hind dark:text-blackColor-dark"
                >
                  <span data-countup-number="27"> 27</span><span>+</span>
                </p>
                <p
                  className="uppercase text-blackColor font-medium leading-[18px] dark:text-blackColor-dark"
                >
                  Total Acheivment
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 pt-30px gap-x-30px">
          ...
          >
            <div className="relative">
              ...
              <h3
                className="text-3xl md:text-size-35 2xl:text-size-38 3xl:text-size-42 leading-10 md:leading-45px 2xl:leading-50px 3xl:leading-2xl font-bold text-blackColor dark:text-blackColor-dark pb-25px"
              >
                Provide It & Technol Subject For You
              </h3>
              <p
                className="text-sm md:text-base text-contentColor dark:text-contentColor-dark mb-10px 2xl:mb-50px"
              >
              ...
              <p
                className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark mb-10 pl-3 border-l-[3px] border-secondaryColor"
              >
                Construction is a general term meaning the art and science to
                form systems organizations, and comes from Latin Construction
          ...
          <div className="relative z-0 overflow-visible">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-30px">
              <div data-aos="fade-up">
                <div
                  className="p-35px group bg-whiteColor rounded-xl transition-all duration-300 shadow-dropdown-secodary hover:bg-primaryColor hover:-translate-y-5px hover:text-whiteColor dark:bg-whiteColor-dark dark:hover:bg-primaryColor"
                >
                  <div
                    className="-translate-y-2 flex justify-between overflow-hidden mb-10px"
                  >
                  ...
                  <div>
                    ...
                    <p
                      className="text-sm lg:text-xs 2xl:text-sm text-contentColor group-hover:text-whiteColor mb-15px lg:mb-2 2xl:mb-15px transition-all duration-300"
                    >
                    ...
                    <div>
                      <div
                        className="text-sm text-black dark:text-blackColor-darkColor group-hover:text-whiteColor dark:text-blackColor-dark dark:group-hover:text-whiteColor-dark"
                      >
                        <a
                          href="#"
    ...
    <section>
      <div
        className="pt-50px pb-10 md:pt-70px md:pb-50px lg:pt-20 2xl:pt-100px 2xl:pb-70px bg-whiteColor dark:bg-whiteColor-dark"
      >
        <div className="filter-container container">
          <div
            className="flex gap-15px lg:gap-30px flex-wrap lg:flex-nowrap items-center"
          >
          ...
          >
            <div
              className="w-full sm:w-1/2 lg:w-1/3 group grid-item filter1 filter3"
            >
            ...
            <div
              className="w-full sm:w-1/2 lg:w-1/3 group grid-item filter2 filter3"
            >
              <div className="tab-content-wrapper sm:px-15px mb-30px">
                <div
                  className="p-15px bg-whiteColor shadow-brand dark:bg-darkdeep3-dark dark:shadow-brand-dark"
                >
                  <div className="relative mb-4">
                    ...
                    >
                      <div>
                        <p
                          className="text-xs text-whiteColor px-4 py-[3px] bg-blue rounded font-semibold"
                        >
                          Mechanical
                        </p>
                      </div>
            ...
            <div
              className="w-full sm:w-1/2 lg:w-1/3 group grid-item filter4 filter5"
            >
              <div className="tab-content-wrapper sm:px-15px mb-30px">
                <div
                  className="p-15px bg-whiteColor shadow-brand dark:bg-darkdeep3-dark dark:shadow-brand-dark"
                >
                  <div className="relative mb-4">
                    ...
                    >
                      <div>
                        <p
                          className="text-xs text-whiteColor px-4 py-[3px] bg-secondaryColor2 rounded font-semibold"
                        >
                          Development
                        </p>
                      </div>
                ...
                >
                  <div className="relative mb-4">
                    ...
                    >
                      <div>
                        <p
                          className="text-xs text-whiteColor px-4 py-[3px] bg-greencolor2 rounded font-semibold"
                        >
                          Ui & UX Design
                        </p>
                      </div>
            ...
            <div
              className="w-full sm:w-1/2 lg:w-1/3 group group grid-item filter1 filter3"
            >
              <div className="tab-content-wrapper sm:px-15px mb-30px">
                <div
                  className="p-15px bg-whiteColor shadow-brand dark:bg-darkdeep3-dark dark:shadow-brand-dark"
                >
                  <div className="relative mb-4">
                    ...
                    >
                      <div>
                        <p
                          className="text-xs text-whiteColor px-4 py-[3px] bg-orange rounded font-semibold"
                        >
                          Data & Tech
                        </p>
                      </div>
            ...
            <div
              className="w-full sm:w-1/2 lg:w-1/3 group grid-item filter2 filter5"
            >
              <div className="tab-content-wrapper sm:px-15px mb-30px">
                <div
                  className="p-15px bg-whiteColor shadow-brand dark:bg-darkdeep3-dark dark:shadow-brand-dark"
                >
                  <div className="relative mb-4">
                    ...
                    >
                      <div>
                        <p
                          className="text-xs text-whiteColor px-4 py-[3px] bg-yellow rounded font-semibold"
                        >
                          Big Data
                        </p>
                      </div>
    ...
    <section className="bg-register bg-cover bg-center bg-no-repeat lg:mb-150px">
      <div
        className="overlay bg-blueDark bg-opacity-90 py-20 lg:pt-[90px] lg:pb-0 relative z-0"
      >
        <div>
          <img
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 pt-30px gap-x-30px">
            ...
            >
              <div className="relative">
                ...
                <h3
                  className="text-3xl md:text-[35px] 2xl:text-size-42 leading-[45px] 2xl:leading-2xl font-bold text-whiteColor pb-25px"
                >
                  Register Your
                  <span
                    className="relative after:w-full after:h-[7px] after:bg-secondaryColor after:absolute after:left-0 after:bottom-2 md:after:bottom-4 z-0 after:z-[-1]"
                    >Account</span
                  >
                  Get free access to
                ...
                <div className="flex gap-x-5 items-center">
                  <div>
                    ...
                    >
                      <span
                        className="animate-buble absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 block w-[180px] h-[180px] border-secondaryColor rounded-full"
                      ></span
                      ><span
                        className="animate-buble2 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 block w-[180px] h-[180px] border-secondaryColor rounded-full"
                      ></span>
                  ...
                  <div>
                    <p
                      className="text-size-15 md:text-[22px] lg:text-lg 2xl:text-[22px] leading-6 md:leading-9 lg:leading-8 2xl:leading-9 font-semibold text-white"
                    >
            ...
            <div
              className="overflow-visible lg:col-start-8 lg:col-span-5 relative z-1 lg:-mb-150px"
            >
              <form
              ...
              >
                <h3
                  className="text-xl text-blackColor dark:text-blackColor-dark font-semibold mb-5 font-inter"
                >
                ...
                <div>
                  ...
                  >
                    Sign Up
                    <i
                      className="icofont-long-arrow-right group-hover:text-primaryColor"
                    ></i>
                  </button>
                </div>
              </form>
      ...
      <div className="container pt-90px pb-100px">
        ...
        <div className="mb-5 md:mb-10">
          <div className="relative" data-aos="fade-up">
            ...
            <h3
              className="text-3xl md:text-size-35 2xl:text-size-38 3xl:text-size-42 md:leading-45px 2xl:leading-50px 3xl:leading-2xl font-bold text-blackColor dark:text-blackColor-dark text-center"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-30px">
          ...
          >
            <div className="relative mb-55px">
              <h3
                className="text-size-28 font-semibold text-blackColor leading-45px mb-15px uppercase dark:text-blackColor-dark"
              >
                Free
              </h3>
              <h6
                className="text-5xl text-blackColor font-medium mb-15px dark:text-blackColor-dark"
              >
                <span className="text-size-58 pr-1">$</span>0
                <span
                  className="text-size-22 text-contentColor dark:text-contentColor-dark"
                  >/ month</span
                >
              </h6>
            ...
            <div>
              <ul className="flex flex-col gap-y-30px">
                <li>
                  <i
                    className="icofont-check text-whiteColor bg-secondaryColor px-1 py-3px mr-15px rounded-full text-xs"
                  ></i
                  ><span
                    className="text-lg text-deepblue font-medium dark:text-deepblue-dark"
                    >2 user</span
                  >
                </li>
                <li>
                ...
                <li>
                  <i
                    className="icofont-close text-whiteColor bg-lightGrey6 px-1 py-3px mr-15px rounded-full text-xs"
                  ></i
                  ><span
                    className="text-lg text-deepblue font-medium dark:text-deepblue-dark"
                  >
                ...
                <li>
                  <i
                    className="icofont-check text-whiteColor bg-lightGrey6 px-1 py-3px mr-15px rounded-full text-xs"
                  ></i
                  ><span
                    className="text-lg text-deepblue font-medium dark:text-deepblue-dark"
                  >
            ...
            <div>
              ...
              >
              <p
                className="text-size-15 text-contentColor dark:text-contentColor-dark"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-15">
          ...
          >
            <div className="relative">
              ...
              <h3
                className="text-3xl md:text-size-35 2xl:text-size-38 3xl:text-size-42 leading-10 md:leading-45px 2xl:leading-50px 3xl:leading-2xl font-bold text-blackColor pb-25px dark:text-blackColor-dark"
              >
                What They Say About us
              </h3>
              <p
                className="text-sm md:text-base text-contentColor mb-5 2xl:mb-45px dark:text-contentColor-dark"
              >
                Construction is a general term meaning the art and science to
                form systems organizations and comes from Latin Construction
                is
          ...
          <div data-aos="fade-up">
            <div
              className="bg-whiteColor px-25px py-50px mb-22px relative dark:bg-whiteColor-dark"
            >
              <p
              ...
              <div
                className="text-xl lg:text-3xl text-whiteColor bg-primaryColor w-10 h-10 lg:w-15 lg:h-15 flex items-center justify-center absolute top-0 left-0 md:-translate-y-1/2 md:-translate-x-1/2 z-20"
              >
                <i className="icofont-quote-left"></i>
              </div>
              <span
                className="w-0 h-0 border-l-12 border-r-12 border-t-15 border-l-transparent border-r-transparent border-t-whiteColor absolute bottom-[-14px] left-[27px] dark:border-t-whiteColor-dark"
              ></span>
            </div>
            ...
            <div className="flex items-center gap-5 2xl:gap-20">
              ...
              <div>
                <h4
                  className="text-xl lg:text-lg 2xl:text-xl font-semibold text-blackColor dark:text-blackColor-dark"
                >
                  Robind Jon
                </h4>
                <p
                  className="text-base lg:text-size-15 2xl:text-base text-lightGrey9 dark:text-lightGrey9-dark"
                >
                  Desginer TechBoot
                </p>
              </div>
      ...
      <div className="container pt-100px pb-70px">
        <div className="mb-5 md:mb-10" data-aos="fade-up">
          <div className="relative">
            ...
            <h3
              className="text-3xl md:text-size-35 2xl:text-size-38 3xl:text-size-42 md:leading-45px 2xl:leading-50px 3xl:leading-2xl font-bold text-blackColor text-center dark:text-blackColor-dark"
            >
              Leatest News & Blog
            </h3>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-30px">
          ...
          >
            <div className="overflow-hidden relative">
              ...
              />
              <div
                className="text-base md:text-3xl leading-5 md:leading-9 font-semibold text-white px-15px py-5px md:px-6 md:py-2 bg-primaryColor rounded text-center absolute top-5 left-5"
              >
                20 <br />
                Oct
              </div>
            ...
            <div className="p-5 md:p-35px md:pt-10">
              <h3
                className="text-2xl md:text-4xl leading-30px md:leading-45px font-bold text-blackColor hover:text-primaryColor pb-25px dark:text-blackColor-dark dark:hover:text-primaryColor"
              >
              ...
              <p
                className="text-base text-contentColor dark:text-contentColor-dark mb-30px"
              >
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                  ...
                  <div
                    className="text-sm md:text-lg text-darkdeep5 dark:text-darkdeep5-dark"
                  >
                    By:
            ...
            <div className="flex flex-col gap-y-30px">
              <div className="group shadow-blog" data-aos="fade-up">
                <div className="overflow-hidden relative">
                  ...
                  />
                  <div
                    className="text-base md:text-2xl leading-5 md:leading-30px font-semibold text-white px-15px py-5px md:px-22px md:py-7px bg-primaryColor rounded text-center absolute top-5 left-5"
                  >
                    20 <br />
                    Oct
                  </div>
                ...
                <div className="px-5 py-25px">
                  <h3
                    className="text-2xl md:text-size-28 leading-30px md:leading-35px font-bold text-blackColor hover:text-primaryColor dark:text-blackColor-dark dark:hover:text-primaryColor"
                  >
                    <a href="blog-details.html"
                      >It is a long established fact that a reader will be
                      Standard Part</a
